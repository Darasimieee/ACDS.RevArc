              ...
              <div className="sm:col-span-2 ">
                ...
                <div className="mt-2">
                  <select
                    ...
                    value={selectedLcda}
                    className="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm placeholder:text-gray-400 sm:text-sm sm:leading-6"
                  >
                    <option value="">Select LCDA</option>
                    {lcdas.map((lcda) => (
                      <option key={lcda.id} value={lcda.id}>
                        {lcda.lcdaName}
                      </option>
                    ))}
                  </select>
